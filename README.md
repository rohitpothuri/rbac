...
## Usage
Since all our machines have java 8 installed and we are using java 19 dependency in this project, docker file installs the required deps and then runs the build
For now the application is running at 8080 port
- In the root directory run
  -  docker build -t aerbac .
- After the build
  - docker run -p 8080:8080 aerbac
...
## Swagger UI
Default swagger UI is at http://localhost:8091/swagger-ui/index.html
