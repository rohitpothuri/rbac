 ...
 *
 ...
 The image below shows an annotated example of a RetryPolicy. There are three steps to using a custom RetryPolicy to control how Activity failure is handled in your Workflow:

 Import the io.temporal.common.RetryOptions; package
 Specify values for one or more properties, such as InitialInterval or BackoffCoefficient, described on the previous page
 Associate your policy with the ActivityOptions used with your Activity

 */
@ActivityImpl(taskQueues = "GreetingTaskQueue")
